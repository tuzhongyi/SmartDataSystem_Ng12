...
} from './garbage_station_request.params';
import { IBusiness } from 'src/app/business/Ibusiness';
import {
  GarbageStation,
  GarbageStationType,
} from 'src/app/network/model/garbage_station.model';
import { GarbageStationUrl } from '../../url/garbage/garbage_station.url';
import {
  BaseRequestService,
  BaseTypeRequestService,
} from '../base_request.service';
import { Camera } from '../../model/camera.model';
import { TrashCan } from '../../model/trash_can.model';
import { GarbageVolume } from '../../model/garbage_volume.model';
import { EventNumberStatistic } from '../../model/event_number_statistic.model';
import { GarbageStationNumberStatistic } from '../../model/garbage_station_number_statistic.model';
import { GarbageStationGarbageCountStatistic } from '../../model/garbage_station_sarbage_count_statistic.model';
import { classToPlain } from 'class-transformer';
import { CameraPictureUrl, RecordFileUrl } from '../../model/url.model';
import { GarbageStationNumberStatisticV2 } from '../../model/garbage_station_number_statistic_v2.model';
import { Member } from '../../model/member.model';
import { GarbageTask } from '../../model/garbage_task.model';
import { GarbageStationNumberStatisticComparison } from '../../model/garbage_station_number_statistic_comparison.model';
import { SumEventNumber } from '../../model/sum_event_number.model';
