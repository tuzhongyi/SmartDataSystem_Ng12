...
import { IllegalMixintoRankBusiness } from './illegal_mixinto_rank.business';
...
@Component({
  ...
  templateUrl: './illegal_mixinto_rank.component.html',
  styleUrls: ['./illegal_mixinto_rank.component.less'],
