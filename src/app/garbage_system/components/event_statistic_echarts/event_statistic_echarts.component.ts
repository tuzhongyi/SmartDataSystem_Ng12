...
import { IllegalStatisticBusiness } from './event_statistic_echarts.business';
...
@Component({
  ...
  templateUrl: './event_statistic_echarts.component.html',
  styleUrls: ['./event_statistic_echarts.component.less'],
