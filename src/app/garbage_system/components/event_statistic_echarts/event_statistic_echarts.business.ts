...
import { EventNumberStatistic } from 'src/app/network/model/event_number_statistic.model';
import { EventNumber } from 'src/app/network/model/event_number.model';
import { GetDivisionEventNumbersParams } from 'src/app/network/request/division/division_request.params';
...
import { EChartsLineModel } from 'src/app/view-model/echarts_line.model';
