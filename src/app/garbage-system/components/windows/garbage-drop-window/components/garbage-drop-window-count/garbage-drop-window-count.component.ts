...
@Component({
  selector: 'howell-garbage-drop-window-count',
  templateUrl: './garbage-drop-window-count.component.html',
  styleUrls: ['./garbage-drop-window-count.component.less'],
...
export class GarbageDropStationWindowCountComponent implements OnInit {
  ...
  getTitle() {
    ...
    let type = EnumTool.resource.from.division(this.args.type);
