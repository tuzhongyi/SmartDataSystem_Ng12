...
export class MediaMultipleControlConverter
  implements IConverter<MediaMultipleControlArgs, MediaMultipleControlModel>
{
  converter = {
  ...
  Convert(
    ...
    let model = new MediaMultipleControlModel();
