...
import { CommonModelPromiseConverter } from "./common-model.converter";
...
export class AICameraEventsConverter extends CommonModelPromiseConverter<AICameraEventsModel>{
