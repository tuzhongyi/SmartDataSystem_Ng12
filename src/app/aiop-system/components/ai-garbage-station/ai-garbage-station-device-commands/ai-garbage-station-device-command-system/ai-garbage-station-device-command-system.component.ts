...
@Component({
  selector: 'ai-garbage-station-device-command-system',
  templateUrl: './ai-garbage-station-device-command-system.component.html',
  styleUrls: [
    '../ai-garbage-station-device-commands.less',
    './ai-garbage-station-device-command-system.component.less',
  ],
  providers: [AIGarbageStationDeviceCommandBusiness],
})
export class AiGarbageStationDeviceCommandSystemComponent implements OnInit {
