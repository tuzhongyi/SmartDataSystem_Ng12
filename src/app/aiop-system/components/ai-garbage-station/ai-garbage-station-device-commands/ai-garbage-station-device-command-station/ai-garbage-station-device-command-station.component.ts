...
@Component({
  selector: 'ai-garbage-station-device-command-station',
  templateUrl: './ai-garbage-station-device-command-station.component.html',
  styleUrls: [
    '../ai-garbage-station-device-commands.less',
    './ai-garbage-station-device-command-station.component.less',
  ],
  providers: [AIGarbageStationDeviceCommandBusiness],
})
export class AiGarbageStationDeviceCommandStationComponent implements OnInit {
