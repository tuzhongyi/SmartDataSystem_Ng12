...
import { CommonModelConverter } from "../../../converter/common-model.converter";
...
export class PlatformManageConverter extends CommonModelConverter<PlatformManageModel>{
