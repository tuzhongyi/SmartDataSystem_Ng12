...
@Component({
  selector: 'aiop-garbage-collection-point-details-window',
  templateUrl: './aiop-garbage-collection-point-details-window.component.html',
  styleUrls: ['./aiop-garbage-collection-point-details-window.component.less'],
})
export class AIOPGarbageCollectionPointDetailsWindowComponent
