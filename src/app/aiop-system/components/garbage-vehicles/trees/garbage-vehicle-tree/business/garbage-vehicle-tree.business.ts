...
import { GarbageVehicleTreeDivisionBusiness } from './garbage-vehicle-tree-division.business';
import { GarbageVehicleTreeVehicleBusiness } from './garbage-vehicle-tree-vehicle.business';

@Injectable()
export class GarbageVehicleTreeBusiness implements IDivisionTreeBusiness {
  ...
  constructor(
    private _division: GarbageVehicleTreeDivisionBusiness,
    private _vehicle: GarbageVehicleTreeVehicleBusiness,
