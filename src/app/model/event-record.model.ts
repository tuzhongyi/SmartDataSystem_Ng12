...
interface EventRecordData<T> extends EventRecord {
  Data: T;
}

/** 乱丢垃圾事件 */
export interface IllegalDropEventRecord
...
/** 混合投放事件 */
export interface MixedIntoEventRecord
 ...
 *
 * */
export interface GarbageFullEventRecord
 ...
 */
export interface GarbageDropEventRecord
